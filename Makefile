...
SRCS = ft_atoi.c ft_isprint.c ft_putchar_fd.c ft_strlen.c ft_putendl_fd.c #ft_strjoin.c ft_strrchr.c ft_bzero.c ft_itoa.c ft_putnbr_fd.c ft_strlcat.c ft_strtrim.c \
...
OBJS = ft_atoi.o ft_isprint.o ft_putchar_fd.o ft_putendl_fd.o #ft_strjoin.o ft_strrchr.o ft_bzero.o ft_itoa.o ft_putnbr_fd.o  ft_strlcat.o ft_strtrim.o \
